  ...
  return (
    <div className="exercise">
      ...
      <p className="expected">
        기대 결과: 사과 / 바나나 / 오렌지 / 포도 / 딸기 5개 항목이 차례로 보여야 합니다.
      </p>
    </div>
  )
}
...
function Problem2() {
  ...
  return (
    <div className="exercise">
      ...
      <p className="expected">
        기대 결과: 홍길동 / 김철수 / 이영희 / 박민수 4명의 카드가 이름과 역할과 함께 보여야 합니다.
      </p>
    </div>
  )
}
...
function Problem3() {
  ...
  return (
    <div className="exercise">
      ...
      <p>
        products 배열을 map으로 순회해서 각 항목을 <code>ProductCard</code> 컴포넌트로 렌더링하세요.
      </p>
      ...
      <p className="expected">
        기대 결과: 노트북/마우스/키보드/모니터 4개의 상품 카드가 이름·가격·재고와 함께 보여야 합니다.
      </p>
    </div>
  )
}
...
function Problem4() {
  ...
  return (
    <div className="exercise">
      ...
      <p>map으로 사용자 목록을 렌더링하되, <code>active</code>가 true인 사용자에게만 "활성" 뱃지를 보여주세요.</p>
      ...
      <p className="expected">
        기대 결과: 4명 모두 이름이 보이되, 홍길동/이영희 옆에만 "활성" 뱃지가 표시됩니다.
      </p>
    </div>
  )
}
...
function Problem5() {
  ...
  return (
    <div className="exercise">
      ...
      <p>
        바깥쪽 map으로 카테고리를, 안쪽 map으로 각 카테고리의 items를 렌더링하세요.
      </p>
      ...
      <p className="expected">
        기대 결과: "과일(사과/바나나/오렌지)", "채소(양파/당근/배추)", "유제품(우유/치즈/요거트)"
        세 카테고리가 각각 아이템 리스트와 함께 표시됩니다.
      </p>
    </div>
  )
}
