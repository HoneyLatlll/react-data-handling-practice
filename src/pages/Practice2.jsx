...
function Problem1() {
  ...
  return (
    <div className="exercise">
      ...
      <p>각 항목의 "삭제" 버튼을 누르면 해당 항목만 목록에서 사라져야 합니다.</p>
...
function Problem2() {
  ...
  return (
    <div className="exercise">
      ...
      <p>"삭제" 버튼을 눌렀을 때 확인 창을 띄우고, "확인"을 눌렀을 때만 삭제되게 만드세요.</p>
      ...
      <p className="expected">
        기대 결과: "삭제" 버튼 클릭 → 브라우저 확인 창 표시 → "확인" 시에만 해당 상품이 사라집니다.
      </p>
    </div>
  )
}
...
function Problem3() {
  ...
  return (
    <div className="exercise">
      ...
      <p>체크박스로 완료 상태를 토글한 뒤, "완료된 항목 삭제" 버튼으로 모든 완료 항목을 한 번에 지우세요.</p>
      ...
      <p className="expected">
        기대 결과: 완료 체크된 항목들이 "완료된 항목 삭제" 버튼 한 번으로 전부 사라집니다.
      </p>
    </div>
  )
}
...
function Problem4() {
  ...
  return (
    <div className="exercise">
      ...
      <p>
        버튼을 눌러 카테고리를 바꿔도 원본 상품 목록은 그대로 두고, 화면에만 필터링된 결과가 보이도록 만드세요.
      </p>
      ...
      <p className="expected">
        기대 결과: 버튼 클릭 시 해당 카테고리 상품만 보이고, "전체"를 누르면 다시 전부 표시됩니다.
        원본 products는 절대 바뀌지 않습니다.
      </p>
    </div>
  )
}
