  ...
  return (
    <div className="page">
      ...
      <p className="page-subtitle">
        챕터 2-1. fetch · 2-2. useEffect 초기 데이터 · 2-3. useEffect 자세히 학습 후
      </p>
...
function Problem1() {
  ...
  return (
    <div className="exercise">
      ...
      <p>
        <code>https://jsonplaceholder.typicode.com/users</code>에서 10명의 사용자를 불러와 화면에 표시하세요.
      </p>
      ...
      <p className="expected">
        기대 결과: 페이지 진입 시 사용자 10명이 이름·이메일·회사명과 함께 목록으로 보여야 합니다.
      </p>
    </div>
  )
}
...
function Problem2() {
  ...
  return (
    <div className="exercise">
      ...
      <p>사용자 id를 바꾸면 해당 사용자의 게시글만 다시 불러와 화면이 갱신되어야 합니다.</p>
      ...
      <p className="expected">
        기대 결과: userId를 바꿀 때마다 목록이 초기화되고 해당 사용자의 게시글만 새로 표시됩니다.
      </p>
    </div>
  )
}
...
function Problem3() {
  ...
  return (
    <div className="exercise">
      ...
      <p>시작/정지를 토글할 수 있는 초 단위 타이머를 만들고, cleanup으로 interval을 정리하세요.</p>
      ...
      <p className="expected">
        기대 결과: 시작 시 1초마다 값이 증가하고, 정지하면 멈춥니다. 다른 실습 페이지로 이동해도
        콘솔에 경고가 뜨지 않아야 합니다.
      </p>
    </div>
  )
...
function Problem4() {
  ...
  return (
    <div className="exercise">
      ...
      <p className="expected">
        기대 결과: 검색어 1글자 이하에서는 결과가 비어있고, 2글자 이상이면 검색 결과가 목록으로 표시됩니다.
      </p>
    </div>
  )
}
